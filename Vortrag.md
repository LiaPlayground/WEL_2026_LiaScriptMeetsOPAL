...
<h2>Wie aus einer Textdatei ein interaktiver Kurs wird — mit KI-Unterstützung</h2>

> **Workshop**
>
> **WeL'26 — Werkstatt eLearning**
>
...
![OER](https://github.com/LiaPlayground/Saechsischer_Schulinformatik_Tag_2026/blob/main/pic/LiaScript_Meets_OER.png?raw=true "OER-Logo - Quelle: Jonathasmello - Eigenes Werk, CC BY 3.0, [https://commons.wikimedia.org/w/index.php?curid=18460156](https://commons.wikimedia.org/w/index.php?curid=18460156) erweitert um LiaScript Logo")
...
# <img src="https://raw.githubusercontent.com/MINT-the-GAP/Aufgabensammlung/refs/heads/main/pics/grad/0.png" width="60" height="60"> Was Sie hier gerade sehen
...
[qr-code](https://github.com/LiaPlayground/WEL_2026_LiaScriptMeetsOPAL "Repository mit allen Materialien")
...
--{{1}}--
Scannen Sie gern einen der beiden Codes. Links öffnet sich der Vortrag, rechts
der Quelltext. Alles, was Sie heute sehen, können Sie danach nachlesen und
weiterverwenden — die Materialien stehen unter einer offenen Lizenz.
...
# <img src="https://raw.githubusercontent.com/MINT-the-GAP/Aufgabensammlung/refs/heads/main/pics/grad/1.png" width="60" height="60"> Drei Ideen
...
--{{1}}--
Zwei Fragezeichen machen aus dem Link eine eingebettete Anwendung. Rechts sehen
Sie eine Sortier-Visualisierung, die Sie direkt bedienen können — eingebunden
mit einer einzigen Zeile Text. Merken Sie sich diese Schreibweise; sie kommt
gleich wieder.


# <img src="https://raw.githubusercontent.com/MINT-the-GAP/Aufgabensammlung/refs/heads/main/pics/grad/2.png" width="60" height="60"> Die Werkstatt
...
Ein LiaScript-Kurs ist **Text**.

Kein Binärformat, keine Datenbank, keine verschachtelte XML-Struktur.
...
Genau deshalb ist ein LiaScript-Kurs für eine KI eine dankbare Aufgabe — und
ein ONYX-Test nicht.
...
# <img src="https://raw.githubusercontent.com/MINT-the-GAP/Aufgabensammlung/refs/heads/main/pics/grad/3.png" width="60" height="60"> Der Weg nach OPAL
...
# <img src="https://raw.githubusercontent.com/MINT-the-GAP/Aufgabensammlung/refs/heads/main/pics/grad/4.png" width="60" height="60"> Einordnung
...
Es ist die Arbeit, die Sie ohnehin leisten — nur an anderer Stelle.

Statt eine leere Seite zu füllen, prüfen und schärfen Sie einen Entwurf.
...
nur formal, sondern praktisch.

Kopieren, ändern, ergänzen: alles mit einem Texteditor.
...
Creative-Commons-Lizenz. Aber Lizenz allein genügt nicht — Nachnutzung
funktioniert nur, wenn das Format sie zulässt. Bei Text ist das der Fall.
...
> Ein Kurs ist Text.
>
> Deshalb kann eine KI ihn schreiben —
>
> und deshalb bleiben **Sie** die Fachperson,
> die ihn verantwortet.
...
<small>TU Bergakademie Freiberg</small>
<small>Institut für Informatik</small>
